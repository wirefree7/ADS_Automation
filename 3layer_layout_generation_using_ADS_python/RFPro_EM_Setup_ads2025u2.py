def rfpro_sim_setup(wrk_name,lib,cell,HOME):
    import os
    ...
    for i in range(1):
        ...
        analysis.name = f'EM_Setup_From_Python'
        ...
        print(f'Running and waiting for simulation...')
        ...
        ts_filename=os.path.join(wrk_space_path,'data',f"RFPro_resut.s2p")
        res.write(ts_filename,"touchstone",17)
        print(f'Touchstone file written for...')
        ...
        output_file = os.path.join(csv_location,f"sparams_result_{i}.csv")
        ...
        print(f"CSV files can be found in: ",csv_location)
